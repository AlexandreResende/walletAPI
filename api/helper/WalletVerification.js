...
module.exports.isWalletValid = (walletId) => {
...
module.exports.hasWalletCards = (userId, walletId) => {
  return new Promise((resolve, reject) => {
...
module.exports.isWalletNewLimitValid = (userId, walletId, cardId, newLimit) => {
  return new Promise((resolve, reject) => {
